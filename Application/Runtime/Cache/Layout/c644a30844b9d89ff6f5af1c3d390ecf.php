...
<div class="list-div">
    <table cellspacing='1' cellpadding='3'>
        <tr>
            <th colspan="4" class="group-title" style='background:    #00A600    '>订单统计信息</th>
        </tr>
        <tr>
...
<div class="list-div">
    <table cellspacing='1' cellpadding='3'>
        <tr>
            <th colspan="4" class="group-title" style='background:  #00A600  '>实体商品统计信息</th>
        </tr>
        <tr>
            <td width="20%">商品总数:</td>
...
<div class="list-div">
    <table cellspacing='1' cellpadding='3'>
        <tr>
            <th colspan="4" class="group-title" style='background:  #00A600  '>系统信息</th>
        </tr>
        <tr>
